...
async function criarNovo() {
  ...
  try {
    const novo = await personagemService.criar({
      ...
      anotacoes: null,
      bonusProficiencia: 2,
      limiteSincronizados: 3,
      detalheIdade: null,
      detalheAltura: null,
      detalhePeso: null,
      detalheCaracteristicas: null,
      personalidadeTracos: null,
      personalidadeIdeais: null,
      personalidadeVinculos: null,
      personalidadeDefeitos: null,
